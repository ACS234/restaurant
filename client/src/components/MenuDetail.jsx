            ...
            <div key={item.id} className="bg-white w-full p-4 rounded-lg shadow-lg">
              ...
              <div className="flex mt-6 space-x-20">
                <button
                  ...
                  className="inline-block px-2 py-2 cursor-pointer bg-green-500 text-white font-light rounded-lg hover:bg-green-600"
                >
                  Add Cart
                </button>
                <button
                  className="inline-block px-2 py-2 cursor-pointer bg-yellow-500 text-white font-semibold rounded-lg hover:bg-yellow-600"
                >
                  Order Now
                </button>
              </div>
